...
function UserDetails({ city, url, twitter, company, darkMode }) {
  return (
    <ul className="flex flex-col gap-y-4">
      <li className="flex shrink-0 gap-x-3">
        <svg
          className={`${getFillClass(darkMode, city)} h-5`}
          height="20"
          width="20"
      ...
      <li className="flex shrink-0 gap-x-3">
        <svg
          className={`${getFillClass(darkMode, url)} h-5`}
          height="20"
          width="20"
          xmlns="http://www.w3.org/2000/svg">
          <g fill="#currentColor">
        ...
        <span
          className={`${getColorClass(darkMode, url)} max-w-full break-words break-all text-sm`}>
      ...
      <li className="flex shrink-0 gap-x-3">
        <svg
          className={`${getFillClass(darkMode, twitter)} h-5`}
          height="20"
          width="20"
          xmlns="http://www.w3.org/2000/svg">
          <path
