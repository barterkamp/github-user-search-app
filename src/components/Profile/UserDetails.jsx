...
function UserDetails({ city, url, twitter, company, darkMode }) {
  return (
    <ul className="grid grid-cols-1 gap-5 md:grid-cols-2">
      <li className="flex shrink-0 gap-x-3 lg:gap-x-6">
        <svg
          className={`${getFillClass(darkMode, city)} h-5 w-5`}
        ...
        <span className={`${getColorClass(darkMode, city)} text-sm`}>
          {city ?? 'Not Available'}
        </span>
      </li>
      ...
      <li className="flex shrink-0 gap-x-3 lg:gap-x-6">
        <svg
          className={`${getFillClass(darkMode, twitter)} h-5 w-5`}
          xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <span className={`${getColorClass(darkMode, twitter)} text-sm`}>
      ...
      <li className="flex shrink-0 gap-x-3 lg:gap-x-6">
        <svg
          className={`${getFillClass(darkMode, url)} h-5 w-6`}
          xmlns="http://www.w3.org/2000/svg">
          <g fill="#currentColor">
        ...
        <span className={`${getColorClass(darkMode, url)} break-all text-sm hover:underline`}>
          {url ? <a href={url}>{url}</a> : <span>Not Available</span>}
        </span>
      </li>

      <li className="flex shrink-0 gap-x-3 lg:gap-x-6">
        <svg
          className={`${getFillClass(darkMode, company)} h-5 w-5`}
          id="company"
          xmlns="http://www.w3.org/2000/svg">
          <g>
            <path
        ...
        <span className={`${getColorClass(darkMode, company)} text-sm`}>
